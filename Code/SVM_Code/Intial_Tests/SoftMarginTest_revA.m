...
[wT,b] = pegasos(ScaledTheta_reduced(:,1:2),y_reduced);
[wT_scaled,b_scaled] = pegasos_SoftMargin(ScaledTheta_reduced(:,1:2),y_reduced);

% Debugging for two class variables
DecisionBoundry1 = wT(1)*ScaledTheta_reduced(:,1) + wT(2)*ScaledTheta_reduced(:,2) + b;
