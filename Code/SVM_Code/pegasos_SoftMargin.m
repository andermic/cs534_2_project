function [wT,b, TrainAccuracy] = pegasos_SoftMargin(X,Y,lamda,maxIter,k,Tolerance,Xi)
% Usage: [W,b,TrainAccuracy] = pegasos(X,Y,lamda,k,maxIter)
% Input:
...
if(nargin<7 || isempty(Xi)),            Xi=0.1;             end
